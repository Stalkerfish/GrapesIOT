...
#define BUFFER_SIZE (OV7670_QVGA_WIDTH * OV7670_QVGA_HEIGHT / BUFFER_COUNT)

uint8_t videoBuffers[BUFFER_COUNT][BUFFER_SIZE];
...
{
    if (hdma->Instance == sp_hdcmi->DMA_Handle->Instance) {
       // Switch to the next buffer
        ...
        printf("Video frame captured and sent over MQTT. Buffer %d\n", currentBufferIndex);
    }
}
